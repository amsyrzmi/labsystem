...
> **Note:** Add your actual application screenshots in a `docs/` folder to display them here.
...
* **Frontend:** Vite, TailwindCSS 4, Blade
* **Database:** MySQL 8.0
* **Infrastructure:** Docker, Docker Compose, Nginx

## 🚀 Getting Started (Docker Installation)

This project is fully containerized using Docker, ensuring a smooth setup process across different environments without polluting your local machine.

### Prerequisites
* [Docker](https://docs.docker.com/get-docker/) installed and running.
* Gitcontent = """# Labcore - Laboratory Management System
