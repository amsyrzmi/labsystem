<x-teacher-layout>
    ...
    <div style="max-width:1100px;margin:20px auto;padding:0 16px;">
        <div style="display:flex;justify-content:space-between;align-items:center;gap:16px;margin-bottom:18px;">
            <h1 style="margin:0;font-size:32px;color:var(--accent);font-weight:700;">My Requests</h1>
                    ...
                    @foreach($requests as $r)
                        <div class="request-card">
                            ...
                            @if($r->rejection_reason !== null)
                                <div style="margin-top:12px;padding:10px;background:linear-gradient(150deg, var(--accent) 0%, #ffffff 100%);border-radius:8px;color:white;font-size:14px;border-left:6px solid var(--accent);">
                            ...
                            <div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px;gap:10px;">
                                <a href="{{ route('teacher.requests.details', $r->id) }}" class="btn-details">
                                    Details
                                </a>
                            </div>
                        </div>
