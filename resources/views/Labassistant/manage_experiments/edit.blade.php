<x-lab-assistant-layout>
    ...
    <div class="container no-shadow">
        <form method="POST" action="{{ route('lab_assistant.manage_experiments.update', $experiment->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="page-header" style="margin-bottom: 24px;">
                <div style="display: flex; justify-content: space-between; align-items: flex-end; width: 100%;">
                    <div>
                        <a href="{{ route('lab_assistant.manage_experiments.index') }}" class="btn-link" style="text-decoration: none; font-size: 13px; font-weight: 700; color: var(--muted);">
                            &larr; BACK TO EXPERIMENTS
                        </a>
                        <h1 class="page-title" style="margin-top: 8px;">Edit Experiment</h1>
                    </div>
                    <div style="display: flex; gap: 12px;">
                        <a href="{{ route('lab_assistant.manage_experiments.index') }}" class="btn btn-cancel">Cancel</a>
